    ...
    >
      ...
      <view-box ref="viewBox" :body-padding-top="isShowNav ? '46px' : '0'" body-padding-bottom="55px">
        ...
        <x-header
          v-if="isShowNav"
          slot="header"
          style="width:100%;position:absolute;left:0;top:0;z-index:100;background-image: linear-gradient(90deg,#ff6f31 0%, 	#ff3652 100%), linear-gradient(#ffb196, 	#ffb196);background-blend-mode: normal, normal;"
        ...
        <tabbar class="vux-demo-tabbar" icon-class="vux-center" v-show="!isTabbarDemo && isShowBar" slot="bottom">
          ...
          <tabbar-item :link="{path:'/login'}" :selected="isDemo" badge="9">
...
<script>
import { Radio, Group, Cell, Badge, Drawer, Actionsheet, ButtonTab, ButtonTabItem, ViewBox, XHeader, Tabbar, TabbarItem, Loading, TransferDom , XInput ,XButton} from 'vux'
...
export default {
  ...
  computed: {
    ...
    title () {
      if (this.route.path === '/') return '待办事项'
